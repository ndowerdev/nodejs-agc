...
const googleSiteVerification = process.env.GOOGLE_WEBMASTER || ''
const sitemapPermalink = process.env.SITE_SITEMAP_LINK || '/sitemap.xml'
const webName = process.env.WEB_NAME || 'nama situs'
const author = process.env.WEB_AUTHOR || 'Admin'
const sitemapList = process.env.SITEMAP_LIST.split(',') || ''
const target = process.env.WEB_TARGET || 'https://ndower.dev'
const mapPermalink = process.env.MAP_PERMALINK.split(',') || [
  'page',
  'content',
  'sitemap',
  'host'
